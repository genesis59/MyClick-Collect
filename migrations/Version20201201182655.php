 ...
 */
final class Version20201201182655 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE ordered (id INT AUTO_INCREMENT NOT NULL, shop_id INT NOT NULL, user_id INT NOT NULL, date DATETIME NOT NULL, status TINYINT(1) NOT NULL, INDEX IDX_C3121F994D16C4DD (shop_id), INDEX IDX_C3121F99A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE shops (id INT AUTO_INCREMENT NOT NULL, trader_id INT NOT NULL, category_id INT NOT NULL, town_id INT NOT NULL, name_shop VARCHAR(255) NOT NULL, picture VARCHAR(255) NOT NULL, presentation LONGTEXT NOT NULL, street_number VARCHAR(255) NOT NULL, street VARCHAR(255) NOT NULL, INDEX IDX_237A67831273968F (trader_id), INDEX IDX_237A678312469DE2 (category_id), INDEX IDX_237A678375E23604 (town_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, town_id INT NOT NULL, email VARCHAR(180) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, phone_number VARCHAR(255) DEFAULT NULL, street_number VARCHAR(255) NOT NULL, street VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), INDEX IDX_8D93D64975E23604 (town_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
